$(".btn").click(function () {
    ...
    const cell1 = window.$(currentTds).eq(0).text(); // eq= cell , text = inner text
    const cell2 = window.$(currentTds).eq(1).text();
    const cell4 = window.$(currentTds).eq(3).text();
    const cell5 = window.$(currentTds).eq(4).text();
